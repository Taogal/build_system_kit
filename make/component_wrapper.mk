...
ifndef PROJECT_PATH
$(error Make was invoked from $(CURDIR). However please do not run make from the sdk or a component directory; invoke make from the project directory. See the Build System Kit README for details.)
endif
...
# ie put literal $(BSD_PATH), $(PROJECT_PATH) and $(BUILD_DIR_BASE) into the generated
...
$(subst $(BSD_PATH),$$(BSD_PATH),$(subst $(PROJECT_PATH),$$(PROJECT_PATH),$(subst $(BUILD_DIR_BASE),$$(BUILD_DIR_BASE),$(1))))
endef
...
# This is a fix for situation where the project or Build System Kit dir moves, and instead
