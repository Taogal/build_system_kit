...
KCONFIG_TOOL_DIR=$(BSD_PATH)/tools/kconfig
...
# overrides (usually used for Build System Kit examples)
...
define RunConf
	...
	$(KCONFIG_TOOL_DIR)/$1 $(BSD_PATH)/Kconfig
endef
...
ifdef BATCH_BUILD
	...
	@echo "See Build System Kit documentation for more details."
	@exit 1
else
	$(call RunConf,mconf)
endif
